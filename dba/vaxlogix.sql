...
CREATE TABLE camp_funcionarios (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE vac_lotes (
    id INT AUTO_INCREMENT PRIMARY KEY,
    codigo_lote VARCHAR(100) NOT NULL UNIQUE
);

-- Tabela de Vacinas
CREATE TABLE vac_vacinas (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE vac_campanha_funcionarios (
    id INT AUTO_INCREMENT PRIMARY KEY,
    campanha_id INT,
    funcionario_id INT,
